...
java_prepare() {
	...
	rm -v lib/{bsh-,commons-codec-,commons-lang3-,commons-net-,htmlparser-,jgoodies-common-,jgoodies-forms-,jgoodies-looks-,jRegistryKey-,opencsv-,skinlf-,stax-,texhyphj-,trident-}*.jar || die
